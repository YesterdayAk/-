      ...
      <div class="content">
        <div class="content-top">
          <div class="movie" ref="movie">
            <img
              v-if="!liveStatus"
              src="https://res1.qdszgh.cn/%E9%B8%BF%E9%9B%81%E8%9E%8D%E7%9B%B4%E6%92%AD/landscape_leave.png"
              alt=""
            />
            <VideoLevelPlayer
              v-else
          ...
          <div class="information" :style="{ top: movieHeight - 44 - 15 + 'px' }">
            <div
              :class="[
                'container',
                'animate__animated',
        ...
        <div class="content-center" v-if="!showPresent">
          ...
          <div
            class="review"
            v-if="!isDescribe"
            :style="{ 'padding-bottom': goodsHeight + 'px' }"
          >
            <Barrage
              ref="barrage"
              @inputBlur="inputBlur"
              ...
              <div class="rest-center">
                ...
                <div class="streaming">
                  ...
                  <div class="streaming-bottom">
                    ...
                    <div
                      class="order_record"
                      v-if="cartInfo.isCart"
                      @click="getOrderRecord"
                    >
...
import VideoLevelPlayer from "@/components/VideoLevelPlayer.vue";
...
export default defineComponent({
  ...
  setup() {
    ...
    const video = ref<InstanceType<typeof VideoLevelPlayer>>();
    ...
    const elementHeight = () => {
      ...
      if (state.isBigScreen) {
        state.describeHeight =
          window.innerHeight - state.movieHeight - state.introduceHeight - 35 - 44 + "px";
      } else {
        state.describeHeight =
          window.innerHeight - state.movieHeight - state.introduceHeight - 44 + "px";
      }
    };
    //获取直播信息
